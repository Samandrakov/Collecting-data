...
# Входной текст
# text = "Привет, меня зовут Петров Павел ВасиЛьевич , я родился первого января 80 года в Москве в 15:30 или 3:30 или в 3 часа или в 15 часов а Вася нет, не знаю никакого Васю"
while True:
    ...
    def time_extraction(input_text, dict):
        time_pattern = re.compile(r'\b(?:2[0-4]|[01]?\d|24) час(?:а|ов)?(?::[0-5]?\d)?\b|\b(?:[01]?\d|2[0-3]):[0-5]?\d\b')
